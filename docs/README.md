...
- In selection mode, **tap covers to pick them, or drag a finger across a run
  of them**. Drag near the top or bottom edge and the list scrolls along with
  you. The bar at the top then changes all of them at once — owned, shelf,
  favourite, delete.
