...
function attachPainting(box) {
  ...
  box.addEventListener('touchstart', (e) => {
    ...
    // Nothing is applied yet: this might still turn out to be a plain tap,
    // which the click handler deals with. The first real movement below
    // claims the starting tile.
    lastId = startId;
    moved = false;
    startFrames();
  }, { passive: true });
